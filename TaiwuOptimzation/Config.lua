return {
	...
	DefaultSettings = {
		...
		[4] = {
			...
			DisplayName = "NPC行动规划优化",
			Description = "开启后启用 NPC 月行动规划热路径优化合集：目标范围索引、关系/物品候选预过滤、target matcher 阶段缓存。最终过滤、随机选择和行动执行仍走原版逻辑。",
			GroupName = "NPC行为循环",
			DefaultValue = true,
		},
		[5] = {
